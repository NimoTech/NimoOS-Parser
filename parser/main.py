...
from parser.routes import allowlist, control, embed, extract, files, files_reindex, folders, health, jobs, models, rerank, render, rescan, stats, test as test_routes
